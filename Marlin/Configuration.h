...
#define STRING_CONFIG_H_AUTHOR "3D Print Pedro" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 6400, 3052.78 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, -3.1 } //Pedro
